                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-12 text-center p-0 mt-3 mb-2">
                                    <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                                        <form id="msform" action="/posting/" method="post">
                                    ...
                                    <p id='progress_show'>20%</p>
                                            ...
                                            <fieldset id='second_slide' class='field_set'>
                                                ...
                                                </div> <input type="button" id='btn' name="next" class="next_s action-button" data-id="60" data-value='third_slide' data-last='second_slide'  value="Next" />
                                            </fieldset>
                                            <fieldset id='third_slide' class='field_set'>
                                                ...
                                                </div> <input type="button" id='btn' name="next" class="next_s action-button" data-id="80" data-value='forth_slide'  data-last='third_slide'  value="Submit" />
                                            </fieldset>
                                            <fieldset id='forth_slide' class='field_set'>
                                                ...
                                                </div> <input type="button" id='btn' name="next" class="next_s action-button" data-id="100" data-value='fifth_slide'  data-last='forth_slide' value="Submit" />
                                            </fieldset>
                                            <fieldset id='fifth_slide' class='field_set'>
                                                <div class="form-card">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 steps-outer">
                                                            ...
                                                            <h4 class="fs-title">Please enter your <strong style="color:#00ae17;">name</strong>, <strong style="color:#00ae17;">email address</strong>, <strong style="color:#00ae17;">phone number</strong>, <strong style="color:#00ae17;">state</strong> and <strong style="color:#00ae17;">zip code</strong> so we may contact you to discuss your tax debt relief options:</h4>
                                                ...
                                                </div> <input type="button" id='btn' name="next" class="next_s action-button" data-id=""  data-value='sixth_slide'  data-last='fifth_slide' value="Submit" />
    ...
    <div class="container">
        <div class="row d-flex align-items-center">
            <div class="col-lg-10 text-lg-left text-center">
                <div class="copyright">
                    Copyright  &copy; 2020. BenefitTaxSolutions.com
                </div>
                <div class="credits">
